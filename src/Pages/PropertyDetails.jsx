...
const PropertyDetails = () => {
  ...
  if (!house) {
    return <div className="text-center text-xl mt-20">Property not found</div>;
  }
      ...
      <div className="container mx-auto mb-14">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h3 className="text-left mb-4">{house.address}</h3>
          </div>
        ...
        <div className="flex-1 bg-white w-full mb-8 border-gray-300 rounded-lg px-6 py-8">
          <div className="flex items-center gap-x-4 mb-8">
            ...
            <div>
              ...
              <Link to={`/agent/${house.agent.id}`} className="text-violet-700 text-sm">View Listings</Link>
            </div>
          </div>
          ...
          <form className="flex flex-col gap-y-4">
            ...
            <div className="flex gap-x-2">
              ...
              <button className="border border-violet-700 text-white hover:border-violet-500 rounded p-4 text-sm w-full transition">
                Call
              </button>
            </div>
          </form>
